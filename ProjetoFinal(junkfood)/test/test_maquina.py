...
class TestMaquina(unittest.TestCase):
    ...
    def testAlterarEspiralComLimiteExcedido(self):
        ...
        self.assertFalse(maquina.alterarEspiral(3, "Coca-Cola", 3, 8.00),
                         "Não deve ser possível alterar as informações da espiral se a quantidade de produtos excede o limite máximo da maquina") # max = 4, qnt = 3, logo, deve ser possivel
